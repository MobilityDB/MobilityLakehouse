# Data read by warehouse_baseline (native tgeompoint + GiST, NO sidecars)
...
PGCONN = "dbname=warehouse_baseline"
...
P0, P1 = T0, T1   # traj shifted at load; no query-side emulation
...
def main() -> None:
    ...
    df.to_csv("results/warehouse_baseline_bytes.csv", index=False)
    print("\nwrote results/warehouse_baseline_bytes.csv")
